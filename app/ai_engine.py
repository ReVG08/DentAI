    ...
    def analyze_images(self, images: List[Image.Image], patient_info: Dict[str, Any]) -> str:
        ...
        try:
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": "You are a highly trained dental professional specialized in diagnostics. Analyze dental images carefully, identify issues, and provide detailed findings."},
